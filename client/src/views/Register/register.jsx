...
export const Register = () => {
  ...
  return (
    <div className="bg-gray-100  h-min-screen ">
      ...
      <div className="flex flex-col min-height-full justify-center card rounded-none p-6 w-1/2 mx-auto h-full objet-cover bg-white m-1">
        <div className="text-center item-center flex justify-center">
              <h1 className="text-center m-1 text-2xl font-bold">Register</h1>
        </div>

     <form  className="bg-white p-10 rounded-lg shadow-md flex flex-col m-1 h-full space-y-1"  onSubmit={handleSubmit}>
