        ...
        <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
          <div className="max-w-md text-center">
            ...
            <p className="mt-4 mb-8 dark:text-gray-400">
              Your search is not valid, please clear the filters.
            </p>
          </div>
        </div>
      </section>
    ...
    <div className="bg-gray-100 dark:bg-gray-800">
      ...
      <div className="min-h-[calc(100vh-7rem)]">
        <nav
          ...
          className="w-3/4 p-4 ml-3 dark:bg-gray-800 dark:text-gray-100"
        >
        ...
        <div className="flex justify-between flex-wrap mt-4 mx-10">
          <select
            ...
            value={selectedBrand}
            onChange={(e) => {
              setSelectedBrand(e.target.value), HandlerFilterTypeFerBrands(e);
            }}
      ...
      dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-300
        shadow-md shadow-gray-400 cursor-pointer focus:outline-none"
          ...
          <select
            ...
            onChange={(e) => {
              setSelectedCapability(e.target.value),
                HandlerFilterTypeFercapabilities(e);
            }}
            className="w-48 bg-gray-100 border border-gray-300 text-gray-900 font-semibold text-md rounded-lg  p-2.5
          dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-300
           shadow-md shadow-gray-400 cursor-pointer focus:outline-none"
          ...
          <select
            id="alphabetically"
            value={selectedAlAlphabet}
            onChange={(e) => {
              setselectedAlphabet(e.target.value), handleFilterTidy(e);
            }}
            className="w-48 bg-gray-100 border border-gray-300 text-gray-900 font-semibold text-md rounded-lg  p-2.5
          dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-300
          shadow-md shadow-gray-400 cursor-pointer focus:outline-none"
          ...
          <select
            ...
            value={selectedPrice}
            onChange={(e) => {
              setSelectedPrice(e.target.value), handleFilterTidyPrice(e);
            }}
            className="w-48 bg-gray-100 border border-gray-300 text-gray-900 font-semibold text-md rounded-lg  p-2.5
          dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-300
          shadow-md shadow-gray-400 cursor-pointer focus:outline-none"
          ...
          <select
            ...
            onChange={(e) => {
              setSelectedRelease(e.target.value), handleFilterTidyReleased(e);
            }}
            className="w-48 bg-gray-100 border border-gray-300 text-gray-900 font-semibold text-md rounded-lg  p-2.5
          dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-300
          shadow-md shadow-gray-400 cursor-pointer focus:outline-none"
